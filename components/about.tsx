export default function About() {
  return (
    <section className="w-1/2 space-y-5 scroll-mt-28" id="about">
      <h2 className="font-medium text-3xl text-gray-700 text-center">About Me</h2>
      <p className="font-mdium text-lg text-gray-700 rounded-xl p-5 hover:scale-110 transition">
